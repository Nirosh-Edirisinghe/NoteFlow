...
import { addCollaborator, createNote, deleteNote, getMyNotes, getNote, removeCollaborator, togglePinNote, updateNote } from '../controllers/noteController.js'
...
noteRouter.delete("/:noteId/collaborators/:collabId", authUser, removeCollaborator);
